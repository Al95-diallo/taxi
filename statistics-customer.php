        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Customer stats</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                        <li class="breadcrumb-item">Statistics</li>
                        <li class="breadcrumb-item active">Customer stats</li>
                    </ol>
                </div>
                <div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group mb-3">
                                            ...
                                            ?>
                                            <label class="mr-sm-2" for="designation">Customer</label>
                                    ...
                                    <div class="col-md-1 m-t-30">
                                        <button type="submit" class="btn btn-dark waves-effect" style="height:37px;" onclick="apply(customer.value,month.value,year.value)">APPLY</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                ?>
                                <h4 class="card-title">Customer stats (<?php echo $tab_currency[0]['symbole']; ?>)</h4>
                                <div class="row">
